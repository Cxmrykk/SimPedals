// Metal Components/Steel Parts/3mm Brake Spring Back Plate x1.scad
// Thickness: 3mm
...
module 3mm_Brake_Spring_Back_Plate() {
    ...
    pts = concat(
        ...
        // Right short ear
        make_arc(60.427, 5, 5, 270, 360),
        [[65.427, 5], [65.427, 15]],
        make_arc(60.427, 15, 5, 0, 90),
        ...
        // Left short ear
        make_arc(-13.927, 15, 5, 90, 180),
        [[-18.927, 15], [-18.927, 5]],
        make_arc(-13.927, 5, 5, 180, 270)
    );
    ...
    difference() {
        ...
        linear_extrude(height = 3) {
            difference() {
                ...
                translate([60.427, 10]) circle(r = 2.5);
                translate([-13.927, 10]) circle(r = 2.5);
